...
const int IOCB_CMD_PREAD = 0;

const int IOCB_CMD_PWRITE = 1;

const int IOCB_CMD_FSYNC = 2;

const int IOCB_CMD_FDSYNC = 3;

const int IOCB_CMD_POLL = 5;

const int IOCB_CMD_NOOP = 6;

const int IOCB_CMD_PREADV = 7;

const int IOCB_CMD_PWRITEV = 8;

const int IOCB_FLAG_RESFD = 1;

const int IOCB_FLAG_IOPRIO = 2;
