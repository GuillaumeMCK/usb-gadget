...
/// Example:
/// ```dart
/// // Create an IN endpoint at address 1
/// final ep = EndpointAddress.in_(EndpointNumber.ep1);
/// print(ep.value); // 0x81
///
/// // Parse from byte
/// final parsed = EndpointAddress.fromByte(0x81);
/// print(parsed.isIn); // true
/// print(parsed.number.value); // 1
/// ```
...
/// Example:
/// ```dart
/// final intf = InterfaceNumber.interface0;
/// print(intf.value); // 0
/// print(intf); // "Interface 0"
/// ```
...
/// Example:
/// ```dart
/// final alt = AlternateSetting.default_;
/// print(alt.value); // 0
/// ```
...
/// Example:
/// ```dart
/// final count = EndpointCount.two;
/// print(count.value); // 2
/// print(count); // "2 endpoints"
/// ```
class EndpointCount {
...
/// Example:
/// ```dart
/// final idx = StringIndex.manufacturer;
/// print(idx.hasString); // true
/// print(idx.value); // 1
/// ```
class StringIndex {
...
/// ```dart
/// // Bulk endpoint
/// final bulk = EndpointAttributes.bulk();
/// print(bulk.value); // 0x02
///
/// // Isochronous with synchronization
/// final iso = EndpointAttributes.isochronous(
///   syncType: IsoSyncType.sync,
///   usageType: IsoUsageType.data,
/// );
/// ```
...
/// Example:
/// ```dart
/// // Full-speed bulk endpoint (must be 8, 16, 32, or 64)
/// final bulk = MaxPacketSize.fullSpeedBulk(64);
///
/// // High-speed isochronous with 2 transactions per microframe
/// final iso = MaxPacketSize.highSpeedIsochronous(
///   size: 1024,
///   transactionsPerMicroframe: 2,
/// );
/// ```
class MaxPacketSize {
...
/// Example:
/// ```dart
/// // Full-speed interrupt: poll every 10 milliseconds
/// final fs = PollingInterval.fullSpeed(10);
///
/// // High-speed interrupt: poll every 8 microframes (1 ms)
/// final hs = PollingInterval.highSpeedInterrupt(4); // 2^(4-1) = 8
/// print(hs.microframes); // 8
/// ```
...
/// Example:
/// ```dart
/// // Bulk endpoint - automatically uses correct packet sizes for each speed
/// final bulk = EndpointConfig.bulk();
///
/// // Interrupt endpoint with 10ms polling at full-speed
/// final interrupt = EndpointConfig.interrupt(
///   pollingMs: 10,
/// );
///
/// // Isochronous endpoint for audio streaming
/// final iso = EndpointConfig.isochronous(
///   syncType: IsoSyncType.sync,
///   usageType: IsoUsageType.data,
/// );
/// ```
...
/// Example:
/// ```dart
/// final burst = BurstSize(3); // 4 packets
/// print(burst.packets); // 4
/// ```
class BurstSize {
...
/// Example:
/// ```dart
/// // Bulk with 16 streams (2^4)
/// final bulk = SSEndpointAttributes.bulk(streams: 4);
///
/// // Isochronous with 3 packets per interval
/// final iso = SSEndpointAttributes.isochronous(mult: 2);
/// ```
...
/// Example:
/// ```dart
/// final bytes = BytesPerInterval(1024);
/// print(bytes); // "1024 bytes/interval"
/// ```
...
/// Example:
/// ```dart
/// final bytes = ExtendedBytesPerInterval(1048576); // 1 MB
/// ```
...
/// Example:
/// ```dart
/// // Composite device with class at interface level
/// final composite = DeviceClass.composite;
///
/// // Vendor-specific device
/// final vendor = DeviceClass.vendorSpecific;
/// ```
class DeviceClass {
...
/// final none = DeviceSubClass.none;
///
/// // Common subclass for miscellaneous devices
/// final common = DeviceSubClass.common;
/// ```
...
/// final none = DeviceProtocol.none;
///
/// // Interface Association Descriptor protocol
/// final iad = DeviceProtocol.iad;
/// ```
...
/// Example:
/// ```dart
/// final interface = USBInterfaceDescriptor(
///   interfaceNumber: InterfaceNumber.interface0,
///   alternateSetting: AlternateSetting.default_,
///   numEndpoints: EndpointCount.two,
///   interfaceClass: USBClass.massStorage,
///   interfaceSubClass: 0x06, // SCSI transparent
///   interfaceProtocol: 0x50, // Bulk-Only Transport
///   stringIndex: StringIndex.none,
/// );
/// ```
...
/// Example:
/// ```dart
/// final endpoint = USBEndpointDescriptorNoAudio(
///   address: EndpointAddress.in_(EndpointNumber.ep1),
///   attributes: EndpointAttributes.bulk(),
///   maxPacketSize: MaxPacketSize.highSpeedBulk(),
...
/// Example:
/// ```dart
/// final audioEp = USBEndpointDescriptor(
///   address: EndpointAddress.out(EndpointNumber.ep2),
///   attributes: EndpointAttributes.isochronous(
///     syncType: IsoSyncType.sync,
///     usageType: IsoUsageType.data,
///   ),
///   maxPacketSize: MaxPacketSize.fullSpeedIsochronous(256),
///   interval: PollingInterval.fullSpeed(1),
///   bRefresh: 0,
///   bSynchAddress: 0x83, // EP3 IN for sync
/// );
/// ```
...
/// Example:
/// ```dart
/// final companion = USBSSEPCompDescriptor(
///   maxBurst: BurstSize(15), // 16 packets per burst
///   attributes: SSEndpointAttributes.bulk(streams: 4), // 16 streams
///   bytesPerInterval: BytesPerInterval.none,
/// );
/// ```
...
/// Example:
/// ```dart
/// final sspComp = USBSSPIsocEndpointDescriptor(
///   bytesPerInterval: ExtendedBytesPerInterval(1048576), // 1 MB
/// );
/// ```
...
/// Example:
/// ```dart
/// final iad = USBInterfaceAssocDescriptor(
///   firstInterface: InterfaceNumber.interface0,
///   interfaceCount: 2, // Video + Audio
///   functionClass: 0x0E, // Video
///   functionSubClass: 0x03, // Video Interface Collection
///   functionProtocol: 0x00,
///   functionString: StringIndex(4),
/// );
/// ```
...
/// Example:
/// ```dart
/// final template = EndpointTemplate(
///   address: EndpointAddress.in_(EndpointNumber.ep1),
///   config: EndpointConfig.bulk(),
/// );
///
/// // Later, generate for specific speed:
/// // final descriptor = generator.generateForSpeed(template, USBSpeed.highSpeed);
/// ```
